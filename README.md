...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/makemake90-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/makemake90-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install makemake90
```
...
It is possible to list all of the versions of `makemake90` available on your platform:
...
```
pixi search makemake90 --channel conda-forge
```
